<?php
    ...
    $id =$_GET['id'];
    $sql3="SELECT * FROM hospitals WHERE isdelete='0' AND doctorid=".$id;
                            ...
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="update_hospitals_process.php?id=<? php echo $id ?>" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Johnathan Doe" class="form-control form-control-line" id="fname" name="name" value="<?php echo $row3['name'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Phone No</label>
                                        <div class="col-md-12">
                                            <input type="tel" placeholder="0171234567890" class="form-control form-control-line" name="contact" value="<?php echo $row3['contact'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Address</label>
                                        <div class="col-md-12">
                                            <input type="text" class="form-control form-control-line" name="address" value="<?php echo $row3['address'];?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
