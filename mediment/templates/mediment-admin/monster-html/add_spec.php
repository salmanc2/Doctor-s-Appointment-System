            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-block">
                                <form class="form-horizontal form-material" action="add_spec_process.php" method="post">
                                    <div class="form-group">
                                        <label for="name" class="col-md-12">Specialization Name</label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Cardiology" class="form-control form-control-line" id="name" name="specname">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
